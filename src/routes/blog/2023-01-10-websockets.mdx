...
export const date = 1673308800000
...
# Outcome
Now I know how to send request from a frontend to a backend using websockets, and using another websocket to get that data from a discord bot, I now have the basic knowledge on how to code a dashboard 🥳
