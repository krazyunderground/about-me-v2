...
export const date = 1670112000000
...
• AI chat (more on that later)<br />
• Randomly sending balls in chat (yes, this is a feature)<br />
• Music command (YT support)<br />

**Some features that are being added are:**

• Admin settings (cant pester me anymore)<br />
• Moderation tools<br />
• Games & Economy<br />
