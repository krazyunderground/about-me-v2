...
export const date = 1670025600000
...
• Multi-page system<br />
• *Awesome* new blogpost system<br />
• Server side rendering<br />
• Full page hydration<br />
• Markdown compatability<br />
• *very* minimalist style<br />
